...
<li>
    ...
    <ul class="submenu">
        ...
        <li><a href="#"><i class='bx bx-bar-chart'></i><span class="text">Thống kê sản phẩm</span></a></li>
    </ul>
</li>
    ...
    <ul class="submenu">
		...
		<li class="has-submenu">
			...
			<ul class="submenu">
				<li><a href="#"><i class='bx bx-list-ul'></i><span class="text">Danh sách đơn hàng</span></a></li>
				<li><a href="#"><i class='bx bx-bar-chart'></i><span class="text">Thống kê đơn hàng</span></a></li>
			</ul>
		</li>
		...
		<li class="has-submenu">
			...
			<ul class="submenu">
				<li><a href="#"><i class='bx bx-list-ul'></i><span class="text">Danh sách sân</span></a></li>
				<li><a href="#"><i class='bx bx-stopwatch'></i><span class="text">Lịch đặt sân</span></a></li>
				<li><a href="#"><i class='bx bx-plus'></i><span class="text">Thêm sân</span></a></li>
			</ul>
		</li>
